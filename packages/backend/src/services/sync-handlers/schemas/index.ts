...
export const saleItemSchema = z.object({
  ...
  deliveredQuantity: optionalNumericStringTransform,
  unitPrice: optionalNumericStringTransform,
  unitPriceQuoted: optionalNumericStringTransform,
  unitPriceFinal: optionalNumericStringTransform,
...
export const saleCreateSchema = z.object({
  ...
  (data) => {
    ...
    return Math.abs(itemsTotal - Number(data.totalAmount)) <= 0.01;
  },
  { message: "El total de la venta debe coincidir con la suma de items", path: ["totalAmount"] }
);
