...
import { RefreshCw, Clock, AlertTriangle, CheckCircle, Database, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        />
        <MetricCard
          label="Operaciones/hora"
          value={metrics.operationsPerHour}
          unit="op/h"
        />
        <MetricCard
            ...
            {entityEntries.slice(0, 8).map(([entity, count]) => {
              ...
              return (
                <div key={entity} className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground w-24 truncate">{entity}</span>
