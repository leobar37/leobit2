 ...
 *
 * ```typescript
 * import { SyncCoordinator } from "@avileo/drizzle-sync/pglite";
 *
 * const coordinator = new SyncCoordinator(
 *   syncService,  // ISyncService implementation
 *   pullService,   // IPullService implementation
 *   {
 *     pushIntervalMs: 5000,
...
import { ExponentialBackoff } from "../core/backoff";
import {
  type ISyncEventEmitter,
  type PullStaleEvent,
} from "../core";
