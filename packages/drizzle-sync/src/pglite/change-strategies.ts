...
import { toSnakeCase, filterValidColumns, isRelationField } from "./schema-mapper";
...
export async function executeUpdate(
  ...
  if (existingResult.rows.length === 0) {
    ...
    return executeInsert(executor, tableName, change, businessId);
  }
