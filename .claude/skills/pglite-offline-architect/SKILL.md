...
description: Architecture guide for PGlite + ElectricSQL + Drizzle ORM hybrid sync. Use when designing offline-first apps where ElectricSQL handles server-to-client sync and REST API handles client-to-server writes with Drizzle ORM shared across frontend and backend.
---
